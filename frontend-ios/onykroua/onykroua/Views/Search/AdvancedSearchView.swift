        ...
        ScrollView(.horizontal, showsIndicators: false) {
            HStack(spacing: 8) {
                ...
                if searchFilter.hasExample == true {
                    FilterPillChip(title: "Avec exemple") {
